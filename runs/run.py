...
with open('../projects.json') as f:
    ...
    for project in projects['projects']:
        ...
        if project['active']:
            ...
            with open('/Users/nima/Developer/NullAwayFixer/Scripts/Diagnoser/config.json', 'w') as outfile:
                json.dump(config, outfile)
            start_time = time.time()
            os.system("cd /Users/nima/Developer/NullAwayFixer/Scripts/Diagnoser/ && python3 run.py loop")
